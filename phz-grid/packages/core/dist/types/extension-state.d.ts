/**
 * @phozart/phz-core — Extended State Types
 *
...
/** @deprecated Use ExtensionState instead */
export type EnterpriseState = ExtensionState;
//# sourceMappingURL=extension-state.d.ts.map