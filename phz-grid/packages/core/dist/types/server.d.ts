...
export declare function isServerFilterGroup(item: ServerFilterCondition | ServerFilterGroup): item is ServerFilterGroup;
...
export type DataSourceErrorCode = 'NETWORK_ERROR' | 'TIMEOUT' | 'AUTH_ERROR' | 'RATE_LIMITED' | 'SERVER_ERROR' | 'ABORTED';
