...
export class ServerExportManager {
  private provider: ServerExportProvider | undefined;
  private pollIntervalMs: number;
  private currentJobId: string | null = null;
  private pollTimer: ReturnType<typeof setTimeout> | null = null;
  private cancelled = false;
  private cancelResolver: ((result: ExportResult) => void) | null = null;

  constructor(
    provider: ServerExportProvider | undefined,
    options?: ServerExportManagerOptions,
  ) {
