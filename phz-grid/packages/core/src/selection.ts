...
} from './types/selection-context.js';

/**
 * Serialize a SelectionContext to URLSearchParams.
 * Arrays are joined with commas.
 */
export function serializeSelection(ctx: SelectionContext): URLSearchParams {
...
export function mergeSelection(
  ...
  overrides: SelectionContext,
): SelectionContext {
  const result: SelectionContext = { ...base };
