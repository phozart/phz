...
export type BuiltinDatePresetId =
...
// ============================================================
// Filter Definition Registry (Selection Criteria Engine)
// ============================================================

// --- Branded ID Types ---

export type FilterDefinitionId = string & { readonly __brand: 'FilterDefinitionId' };
export type ArtefactId = string & { readonly __brand: 'ArtefactId' };

export function filterDefinitionId(id: string): FilterDefinitionId { return id as FilterDefinitionId; }
export function artefactId(id: string): ArtefactId { return id as ArtefactId; }
...
export type StateResolutionLevel =
  | 'rule'
  | 'preset'
  | 'persisted'
  | 'binding_default'
...
export type FilterRuleConfig =
  | ExcludePatternConfig
  | IncludePatternConfig
  | TreeGroupCompareConfig
  | ValueSetConfig
  | CustomRuleConfig
  | CrossFilterConfig;
...
export type CrossFilterConditionOperator =
  | 'equals' | 'not_equals'
  | 'in' | 'not_in'
  | 'is_set' | 'is_not_set';
...
export type CrossFilterActionType =
  | 'include_values'
  | 'exclude_values'
  | 'include_from_context'
