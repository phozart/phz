/**
 * @phozart/core — Event Types
 */

import type { RowId, RowData } from './row.js';
import type { CellPosition } from './cell.js';
import type { GridState, SortState, FilterState, FilterPreset } from './state.js';
...
export type GridEventHandler<K extends keyof GridEventMap> = (
  event: GridEventMap[K],
) => void | boolean;
