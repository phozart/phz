...
export interface UseGridReturn {
  gridInstance: { value: GridApi | null };
  state: { value: GridState | null };
...
export interface UseGridSortReturn {
  sortState: { value: SortState | null };
...
export interface UseGridFilterReturn {
  filterState: { value: FilterState | null };
...
export interface UseGridEditReturn {
  editState: { value: EditState | null };
