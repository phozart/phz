...
export class PhzViewerExplorer extends LitElement {
  ...
  @state()
  private _explorerState: ExplorerScreenState = createExplorerScreenState();
  ...
  selectSource(sourceId: string): void {
    ...
    this.requestUpdate();
    this.dispatchEvent(
      new CustomEvent('explorer-source-select', {
      ...
      <div class="explorer-layout">
        ...
        <div class="explorer-main">
          <div class="preview-mode-tabs">
            ${(['table', 'chart', 'pivot'] as ExplorerPreviewMode[]).map(
              mode => html`
                <button
  ...
  private _handleSourceSelect(e: Event): void {
  ...
  private _handleFieldSearch(e: Event): void {
    const value = (e.target as HTMLInputElement).value;
    this._explorerState = setFieldSearch(this._explorerState, value);
    this.requestUpdate();
  }

  private _handleFieldClick(field: FieldMetadata): void {
    ...
    this.dispatchEvent(
      new CustomEvent('explorer-field-add', {
        bubbles: true, composed: true,
  ...
  private _handlePreviewMode(mode: ExplorerPreviewMode): void {
