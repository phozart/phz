...
export function createValueOnlyRenderer(): MicroWidgetRenderer {
  return {
    ...
    canRender(_config: MicroWidgetCellConfig, columnWidth: number): boolean {
 ...
 */
function normalizeSparklineData(value: unknown): number[] {
 ...
 */
function parseDeltaValue(value: unknown): { current: number; previous: number } | null {
