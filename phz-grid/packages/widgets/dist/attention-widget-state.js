 ...
 */
export function initialAttentionWidgetState(items, maxItems = 5) {
 ...
 */
export function computePrioritySummary(state) {
 ...
 */
export function getTopItems(state, n) {
 ...
 */
export function getContainerVariant(containerWidth) {
...
//# sourceMappingURL=attention-widget-state.js.map