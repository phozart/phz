...
let PhzSelectionBar = class PhzSelectionBar extends LitElement {
    constructor() {
        super(...arguments);
        this.fields = [];
    ...
    handleSingleSelect(field, e) {
        if (field.locked)
            return;
        const select = e.target;
        const oldValue = this.selectionContext[field.id] ?? null;
    ...
    handleChipToggle(field, value) {
        if (field.locked)
            return;
        const current = this.selectionContext[field.id] ?? [];
        ...
        switch (field.type) {
          ...
          <div class="selection-field">
            ...
            <select class="selection-field__select"
                    ...
                    @change=${(e) => this.handleSingleSelect(field, e)}
        ...
        `;
          ...
          <div class="selection-field">
            ...
            <select class="selection-field__select" multiple
                    ?disabled=${field.locked}
                    @change=${(e) => this.handleMultiSelect(field, e)}
                    aria-label=${field.label}>
        ...
        `;
          ...
          <div class="selection-field">
            ...
            <input class="selection-field__input"
                   ...
                   .value=${currentValue ?? ''}
                   ?disabled=${field.locked}
                   @input=${(e) => this.handleTextInput(field, e)}
                   aria-label=${field.label}
...
__decorate([
    property({ type: Array })
], PhzSelectionBar.prototype, "fields", void 0);
__decorate([
    property({ type: Object })
], PhzSelectionBar.prototype, "selectionContext", void 0);
__decorate([
    property({ type: String })
], PhzSelectionBar.prototype, "persistTo", void 0);
PhzSelectionBar = __decorate([
    customElement('phz-selection-bar')
], PhzSelectionBar);
export { PhzSelectionBar };
//# sourceMappingURL=phz-selection-bar.js.map