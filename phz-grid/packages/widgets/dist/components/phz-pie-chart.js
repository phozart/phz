...
let PhzPieChart = class PhzPieChart extends LitElement {
    constructor() {
        super(...arguments);
        this.data = [];
        this.donut = false;
    ...
    handleSliceHover(e, slice) {
        const container = e.currentTarget.closest('.pie-container');
        if (!container)
            return;
          ...
          <svg class="pie-svg" width="${size}" height="${size}" viewBox="0 0 ${size} ${size}"
            ...
            return svg `
                <path class="pie-slice phz-w-clickable"
                      ...
                      @mouseenter=${(e) => this.handleSliceHover(e, slice)}
                      @mouseleave=${() => this.handleSliceLeave()}
                      @focus=${(e) => {
                this.focusedIndex = i;
                const el = e.currentTarget;
                const container = el.closest('.pie-container');
                if (!container)
                    return;
                const rect = container.getBoundingClientRect();
...
], PhzPieChart.prototype, "data", void 0);
__decorate([
    property({ type: Boolean })
], PhzPieChart.prototype, "donut", void 0);
__decorate([
    property({ type: Boolean, attribute: 'show-legend' })
], PhzPieChart.prototype, "showLegend", void 0);
__decorate([
    property({ type: Boolean, attribute: 'show-labels' })
], PhzPieChart.prototype, "showLabels", void 0);
__decorate([
    property({ type: String })
], PhzPieChart.prototype, "title", void 0);
__decorate([
    property({ type: Boolean })
], PhzPieChart.prototype, "loading", void 0);
__decorate([
    property({ type: String })
], PhzPieChart.prototype, "error", void 0);
__decorate([
    state()
], PhzPieChart.prototype, "tooltipContent", void 0);
__decorate([
    state()
], PhzPieChart.prototype, "tooltipVisible", void 0);
__decorate([
    state()
], PhzPieChart.prototype, "tooltipStyle", void 0);
__decorate([
    state()
], PhzPieChart.prototype, "focusedIndex", void 0);
PhzPieChart = __decorate([
    customElement('phz-pie-chart')
], PhzPieChart);
export { PhzPieChart };
//# sourceMappingURL=phz-pie-chart.js.map