...
export function filterAlerts(alerts, filter, now) {
    return alerts.filter(alert => {
        if (filter.severity && alert.severity !== filter.severity)
            return false;
        if (filter.kpiId && alert.kpiId !== filter.kpiId)
            return false;
        if (filter.showAcknowledged === false && alert.acknowledged)
            return false;
...
export function computeBadgeCount(alerts, now) {
...
// -- Components --
let PhzAlertBadge = class PhzAlertBadge extends LitElement {
    constructor() {
        super(...arguments);
        this.count = 0;
...
], PhzAlertBadge.prototype, "count", void 0);
__decorate([
    property({ type: String })
], PhzAlertBadge.prototype, "severity", void 0);
PhzAlertBadge = __decorate([
    customElement('phz-alert-badge')
], PhzAlertBadge);
export { PhzAlertBadge };
let PhzAlertPanel = class PhzAlertPanel extends LitElement {
    constructor() {
        super(...arguments);
        this.alerts = [];
        this.severityFilter = '';
    ...
    get filteredAlerts() {
        ...
        if (this.severityFilter)
            filter.severity = this.severityFilter;
        if (this.kpiFilter)
            filter.kpiId = this.kpiFilter;
      ...
      <div class="phz-w-card" role="region" aria-label="KPI Alerts" aria-live="polite">
        ...
        <div class="filter-bar" role="toolbar" aria-label="Alert filters">
          <select aria-label="Filter by severity"
                  @change=${(e) => { this.severityFilter = e.target.value; }}>
          ...
          <select aria-label="Filter by KPI"
                  @change=${(e) => { this.kpiFilter = e.target.value; }}>
...
__decorate([
    property({ type: Array })
], PhzAlertPanel.prototype, "alerts", void 0);
__decorate([
    state()
], PhzAlertPanel.prototype, "severityFilter", void 0);
__decorate([
    state()
], PhzAlertPanel.prototype, "kpiFilter", void 0);
__decorate([
    state()
], PhzAlertPanel.prototype, "showAcknowledged", void 0);
PhzAlertPanel = __decorate([
    customElement('phz-alert-panel')
], PhzAlertPanel);
export { PhzAlertPanel };
//# sourceMappingURL=phz-alert-panel.js.map