...
function tokenValue(key) {
    return ALERT_WIDGET_TOKENS[key] ?? '';
}
// ========================================================================
// Indicator size by container
// ========================================================================
function indicatorSize(containerSize) {
...
// ========================================================================
function borderWidth(containerSize) {
    switch (containerSize) {
 ...
 */
export function computeAlertStyles(config, state, containerSize) {
    const result = {};
...
//# sourceMappingURL=alert-aware-rendering.js.map