 ...
 */
export function getKPICardClass(width) {
    if (width > 280)
        return 'kpi--full';
    if (width >= 200)
        return 'kpi--compact';
 ...
 */
export function getChartClass(width) {
    if (width > 400)
        return 'chart--full';
    if (width >= 280)
        return 'chart--no-legend';
    if (width >= 160)
 ...
 */
export function getTableClass(width) {
    if (width > 600)
        return 'table--all';
    if (width >= 400)
        return 'table--hide-low';
    if (width >= 300)
        return 'table--hide-medium';
    return 'table--card';
}
// ========================================================================
 ...
 */
export function getFilterBarClass(width) {
    if (width > 600)
        return 'filter-bar--row';
    if (width >= 400)
        return 'filter-bar--two-col';
 ...
 */
export function getVisibleColumns(columns, width) {
    if (width > 600) {
 ...
 */
export function getDecisionTreeClass(width) {
    if (width > 500)
        return 'tree--full';
    if (width >= 300)
        return 'tree--compact';
 ...
 */
export function getContainerBoxClass(width) {
    if (width > 600)
 ...
 */
export function shouldStackContainerChildren(width, childCount) {
    if (width < 400)
        return true;
    if (width < 600 && childCount > 2)
        return true;
    return false;
}
// ========================================================================
 ...
 */
export function getRichTextClass(width) {
    if (width > 500)
        return 'rich-text--full';
    if (width >= 300)
        return 'rich-text--compact';
