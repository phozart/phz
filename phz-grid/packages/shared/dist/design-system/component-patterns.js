 ...
 */
export function getFormDensityClasses(density) {
    return {
 ...
 */
export function getModalClasses(options) {
 ...
 */
export function getDrawerClasses(options) {
    const parts = [`drawer drawer--${options.position}`];
    if (options.open)
        parts.push('drawer--open');
 ...
 */
export function getEmptyStateProps(stateType) {
 ...
 */
export function getSkeletonClass(variant) {
