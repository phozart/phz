...
// ========================================================================
export const ERROR_MESSAGE_POOLS = [
    // --- network-error ---
    {
...
// ========================================================================
export const EMPTY_STATE_MESSAGE_POOLS = [
    // --- no-data ---
    {
        scenario: 'no-data',
        tone: 'friendly',
 ...
 */
export function getRandomMessage(scenario, tone, pools) {
 ...
 */
export function getAllMessages(scenario, pools) {
    const result = {
        friendly: [],
        technical: [],
        minimal: [],
 ...
 */
export function getScenarios(pools) {
 ...
 */
export function countMessages(pools) {
    return pools.reduce((sum, pool) => sum + pool.messages.length, 0);
}
//# sourceMappingURL=message-pools.js.map