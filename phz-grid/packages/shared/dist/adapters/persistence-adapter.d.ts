/**
 * @phozart/shared — PersistenceAdapter SPI
 *
...
export interface PersistenceAdapter {
     ...
     */
    deleteFilterPreset(presetId: string): Promise<{
        success: boolean;
        error?: string;
    }>;
    /**
     ...
     */
    deletePersonalView(viewId: string): Promise<{
        success: boolean;
        error?: string;
    }>;
    /**
     ...
     */
    loadLastAppliedFilters?(userId: string, artifactId: string): Promise<LastAppliedFilters | null>;
    /**
     ...
     */
    deletePersonalAlert?(alertId: string): Promise<{
        success: boolean;
        error?: string;
    }>;
    /**
     ...
     */
    listAvailableRoles?(): Promise<Array<{
        id: string;
        name: string;
        description?: string;
    }>>;
