 ...
 */
export type UsageEventType = 'page-view' | 'artifact-open' | 'artifact-create' | 'artifact-save' | 'artifact-delete' | 'artifact-share' | 'artifact-publish' | 'filter-apply' | 'filter-reset' | 'filter-preset-select' | 'sort-change' | 'column-resize' | 'column-reorder' | 'column-toggle' | 'export-start' | 'export-complete' | 'drill-through' | 'cross-filter' | 'widget-interact' | 'search-execute' | 'alert-triggered' | 'alert-acknowledged' | 'subscription-create' | 'subscription-cancel' | 'session-start' | 'session-end';
...
//# sourceMappingURL=usage-analytics-adapter.d.ts.map