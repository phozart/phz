...
export interface SubscriptionAdapter {
     ...
     */
    create(subscription: ReportSubscription): Promise<{
        id: string;
        success: boolean;
    }>;
    /**
     ...
     */
    update(subscription: ReportSubscription): Promise<{
        success: boolean;
        error?: string;
    }>;
    /**
     ...
     */
    triggerNow?(subscriptionId: string): Promise<{
        success: boolean;
    }>;
}
//# sourceMappingURL=subscription-adapter.d.ts.map