...
// ========================================================================
// MeasureDefinition — reusable calculated measure
// ========================================================================
...
// ========================================================================
// KPIDefinition — business-level metric built on measures
// ========================================================================
...
// ========================================================================
// MeasureRegistryAdapter interface
// ========================================================================
...
export interface MeasureRegistryAdapter {
   ...
   */
  saveMeasure(measure: MeasureDefinition): Promise<{ id: string; success: boolean }>;

  /**
   * Delete a measure by ID.
   */
  deleteMeasure(measureId: string): Promise<{ success: boolean; error?: string }>;
   ...
   */
  saveKPI(kpi: KPIDefinition): Promise<{ id: string; success: boolean }>;
