...
// ========================================================================
// APIRoleAccess — role-based endpoint access control
// ========================================================================
...
// ========================================================================
// APISpecConfig — complete API specification configuration
// ========================================================================
...
export function createApiEndpoint(
  ...
  path: string,
  description: string,
  options?: Partial<Omit<ApiEndpoint, 'method' | 'path' | 'description'>>,
): ApiEndpoint {
