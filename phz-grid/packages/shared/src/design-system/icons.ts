...
export const ICONS = {
  ...
  dashboard:
    'M3 3h8v10H3V3zm10 0h8v6h-8V3zM13 11h8v10h-8V11zM3 15h8v6H3v-6z',

  /** Report: document with lines */
  report:
    'M6 2h8l4 4v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm7 0v5h5M8 10h8M8 14h8M8 18h5',
  ...
  kpi:
    'M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20zm0 14V8m-3 3l3-3 3 3',

  /** Metric: sigma/summation symbol */
  metric:
    'M6 4h12M6 4l6 8-6 8h12',

  /** Alert rule: bell with dot */
  alertRule:
    'M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9zM13.73 21a2 2 0 0 1-3.46 0M20 4a2 2 0 1 1 0 .01',
  ...
  filterDefinition:
    'M20 3H2l7 8.5V17l4 2v-7.5L20 3zM19 14a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm0 1.5v3m1.3-2.25l-2.6 1.5m0-1.5l2.6 1.5',

  /** Filter rule: funnel with checkmark */
  filterRule:
    'M20 3H2l7 8.5V17l4 2v-7.5L20 3zM16 18l2 2 4-4',

  /** Subscription: envelope */
  subscription:
    'M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm0 2l8 5 8-5',

  // -- Field Types ----------------------------------------------------------
  /** Text field: "Aa" text icon */
  fieldText:
    'M4 18l4-12h2l4 12M5.5 14h7M16 6h2a2 2 0 0 1 0 4h-2v8m0-8h1.5a2.5 2.5 0 0 1 0 5H16',

  /** Number field: hash/pound */
  fieldNumber:
    'M4 8h16M4 16h16M8 3v18M16 3v18',

  /** Date field: calendar */
  fieldDate:
    'M19 4H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM16 2v4M8 2v4M3 10h18M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01',

  /** Boolean field: toggle switch */
  fieldBoolean:
    'M8 5h8a7 7 0 1 1 0 14H8A7 7 0 1 1 8 5zm8 3a4 4 0 1 1 0 8 4 4 0 0 1 0-8z',
  ...
  sourceUpload:
    'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-2 12v6m0-6l-3 3m3-3l3 3M14 2v6h6',

  /** CSV: document with comma-separated lines */
  sourceCsv:
    'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zM14 2v6h6M8 13h2M11 13h2M14 13h2M8 17h2M11 17h2',

  /** Excel: spreadsheet grid */
  sourceExcel:
    'M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 6h18M4 14h18M10 4v16M16 4v16',

  /** Parquet: columnar blocks */
  sourceParquet:
    'M4 4h4v16H4V4zm6 0h4v16h-4V4zm6 0h4v16h-4V4zM4 10h4M10 8h4M16 12h4M4 16h4M10 14h4M16 18h4',

  /** JSON: curly braces */
  sourceJson:
    'M8 3c-2 0-3 1-3 3v4c0 1-1 2-2 2 1 0 2 1 2 2v4c0 2 1 3 3 3M16 3c2 0 3 1 3 3v4c0 1 1 2 2 2-1 0-2 1-2 2v4c0 2-1 3-3 3M10 12h.01M14 12h.01',
  ...
  sourceApi:
    'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM2 12h20M12 2a15 15 0 0 1 4 10 15 15 0 0 1-4 10M12 2a15 15 0 0 0-4 10 15 15 0 0 0 4 10',
  ...
  /** Home */
  home:
    'M3 12l2-2m0 0l7-7 7 7m-9-5v12a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1V10m-9 9l9-9',
  ...
  /** Settings/gear */
  settings:
    'M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z',
  ...
  /** Alert/bell */
  alert:
    'M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9zM13.73 21a2 2 0 0 1-3.46 0',
  ...
  /** Duplicate/copy */
  duplicate:
    'M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-2M4 16V4a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z',
  ...
  /** Add in circle */
  addCircle:
    'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM12 8v8M8 12h8',
  ...
  drillThrough:
    'M15 3h6v6M14 10l7-7M10 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6',
  ...
  /** Info/circle-i */
  info:
    'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM12 16v-4M12 8h.01',
  ...
  /** Drag handle: 6 dots */
  dragHandle:
    'M9 4h.01M9 9h.01M9 14h.01M9 19h.01M15 4h.01M15 9h.01M15 14h.01M15 19h.01',
  ...
  /** Pin */
  pin:
    'M12 17v5M15 9.34V4H9v5.34M18 9.34a1.17 1.17 0 0 1-1 1.66H7a1.17 1.17 0 0 1-1-1.66L9 4h6l3 5.34z',

  /** Columns/layout */
  columns:
    'M12 3v18M3 3h18v18H3V3z',
  ...
  lineage:
    'M4 6a2 2 0 1 0 4 0 2 2 0 0 0-4 0zM4 18a2 2 0 1 0 4 0 2 2 0 0 0-4 0zM16 12a2 2 0 1 0 4 0 2 2 0 0 0-4 0zM8 6h4a2 2 0 0 1 2 2v2l2 2M8 18h4a2 2 0 0 0 2-2v-2l2-2',
} as const;

// ========================================================================
// Icon Type (keys of ICONS)
// ========================================================================
...
export const ARTIFACT_ICONS: Record<string, IconName> = {
  'dashboard': 'dashboard',
  'report': 'report',
...
export const FIELD_TYPE_ICONS: Record<string, IconName> = {
  'string': 'fieldText',
  'text': 'fieldText',
  'number': 'fieldNumber',
  'integer': 'fieldNumber',
...
const LEGACY_FIELD_TYPE_ICONS: Record<string, string> = {
  string: 'Aa',
  number: '#',
  date: '\u2630',
  boolean: '\u2713',
 ...
 */
export function getFieldTypeIconSvg(
  dataType: string,
  size: number = 16,
  color: string = 'currentColor',
): string {
  const iconName = FIELD_TYPE_ICONS[dataType] as IconName | undefined;
 ...
 */
export function getCardinalityBadgeClass(cardinality: string): string {
 ...
 */
export function getDropZoneClass(zoneType: string, dragOver: boolean): string {
...
function renderPaths(pathData: string): string {
