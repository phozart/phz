...
let PhzChartPopover = class PhzChartPopover extends LitElement {
    constructor() {
        super(...arguments);
        this.open = false;
        this.field = '';
  ...
  `; }
    ...
    show(field, header, values, labels) {
        this.field = field;
    ...
    removeListeners() { this.cleanup?.(); this.cleanup = null; }
    render() {
        if (!this.open || this.values.length === 0)
            return html ``;
...
], PhzChartPopover.prototype, "open", void 0);
__decorate([
    property({ type: String })
], PhzChartPopover.prototype, "field", void 0);
__decorate([
    property({ type: String })
], PhzChartPopover.prototype, "columnHeader", void 0);
__decorate([
    property({ attribute: false })
], PhzChartPopover.prototype, "values", void 0);
__decorate([
    property({ attribute: false })
], PhzChartPopover.prototype, "labels", void 0);
__decorate([
    state()
], PhzChartPopover.prototype, "chartType", void 0);
__decorate([
    state()
], PhzChartPopover.prototype, "posX", void 0);
__decorate([
    state()
], PhzChartPopover.prototype, "posY", void 0);
PhzChartPopover = __decorate([
    customElement('phz-chart-popover')
], PhzChartPopover);
export { PhzChartPopover };
//# sourceMappingURL=phz-chart-popover.js.map