...
let PhzViewSwitcher = class PhzViewSwitcher extends LitElement {
    constructor() {
        super(...arguments);
        this.views = [];
        this.isDirty = false;
    ...
    _selectView(id) {
        this._open = false;
        this.dispatchEvent(new CustomEvent('view-select', { detail: { viewId: id }, bubbles: true, composed: true }));
    }
};
__decorate([
    property({ attribute: false })
], PhzViewSwitcher.prototype, "views", void 0);
__decorate([
    property({ type: Boolean, attribute: 'is-dirty' })
], PhzViewSwitcher.prototype, "isDirty", void 0);
__decorate([
    property({ type: String, attribute: 'active-view-name' })
], PhzViewSwitcher.prototype, "activeViewName", void 0);
__decorate([
    state()
], PhzViewSwitcher.prototype, "_open", void 0);
PhzViewSwitcher = __decorate([
    customElement('phz-view-switcher')
], PhzViewSwitcher);
export { PhzViewSwitcher };
//# sourceMappingURL=phz-view-switcher.js.map