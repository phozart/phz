...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: '@phozart/grid-admin', replacement: resolve(__dirname, '../workspace/src/grid-admin/index.ts') },
      { find: '@phozart/engine-admin', replacement: resolve(__dirname, '../workspace/src/engine-admin/index.ts') },
    ],
  },
});
