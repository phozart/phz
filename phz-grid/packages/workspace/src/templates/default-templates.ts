...
function grid(children: LayoutNode[], minItemWidth = 200, gap = 16): LayoutNode {
  return { kind: 'auto-grid', minItemWidth, gap, children };
}

function widget(widgetId: string, weight?: number): LayoutNode {
  return { kind: 'widget', widgetId, weight };
}

function sections(secs: Array<{ title: string; children: LayoutNode[] }>): LayoutNode {
...
export function registerDefaultTemplates(target: TemplateDefinition[]): void {
