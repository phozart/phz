...
export const adminBaseStyles = css`
  ...
  *, *::before, *::after { box-sizing: inherit; }
  ...
  .phz-admin-btn--primary { background: #3B82F6; color: white; border-color: #3B82F6; }
  .phz-admin-btn--primary:hover { background: #2563EB; box-shadow: var(--phz-admin-shadow-md); }
  .phz-admin-btn--danger { color: #DC2626; }
  .phz-admin-btn--danger:hover { background: #FEF2F2; }
  ...
  .phz-admin-toggle input:checked + .phz-admin-toggle-slider { background: #3B82F6; }
  ...
  .phz-admin-tab:hover { color: #44403C; }
  .phz-admin-tab--active { color: #3B82F6; border-bottom-color: #3B82F6; }
