...
import type { ManifestRegistry } from './widget-registry.js';
...
const kpiScorecard: WidgetManifest = {
  type: 'kpi-scorecard',
  category: 'kpis',
  name: 'KPI Scorecard',
...
const trendLine: WidgetManifest = {
  type: 'trend-line',
  category: 'charts',
  name: 'Trend Line',
...
const gaugeWidget: WidgetManifest = {
  type: 'gauge',
  category: 'charts',
  name: 'Gauge',
...
const lineChart: WidgetManifest = {
  type: 'line-chart',
  category: 'charts',
  name: 'Line Chart',
...
const areaChart: WidgetManifest = {
  type: 'area-chart',
  category: 'charts',
  name: 'Area Chart',
...
const dataTable: WidgetManifest = {
  type: 'data-table',
  category: 'tables',
  name: 'Data Table',
...
const pivotTable: WidgetManifest = {
  type: 'pivot-table',
  category: 'tables',
  name: 'Pivot Table',
...
const statusTable: WidgetManifest = {
  type: 'status-table',
  category: 'tables',
  name: 'Status Table',
...
const drillLink: WidgetManifest = {
  type: 'drill-link',
  category: 'navigation',
  name: 'Drill Link',
...
export function registerDefaultManifests(registry: ManifestRegistry): void {
