...
import {
  ...
  promoteArtifact,
  revokeEndorsement,
  startEndorsementAction,
  commitEndorsementAction,
  cancelEndorsementAction,
  sortByEndorsement,
  filterByEndorsement,
  getEndorsementBadge,
} from '../certification-state.js';
...
describe('certification-state', () => {
  ...
  it('sortByEndorsement orders promoted > certified > verified > none', () => {
    ...
    const endorsements: Record<string, ArtifactEndorsement> = {
      a: { level: 'none' },
