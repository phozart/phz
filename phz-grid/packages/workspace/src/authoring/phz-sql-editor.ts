...
export class PhzSqlEditor extends LitElement {
  static styles = css`
    :host {
      display: flex;
  ...
  @property({ attribute: false }) executeSql?: SqlExecutor;
  @state() private _state: SqlEditorState = initialSqlEditorState();
  ...
  private _onHistorySelect(e: Event) {
