...
describe('page-nav component logic', () => {
  ...
  it('supports all three positions', () => {
    const positions: PageNavConfig['position'][] = ['top', 'left', 'bottom'];
    positions.forEach(pos => {
      const config: PageNavConfig = { ...DEFAULT_PAGE_NAV_CONFIG, position: pos };
  ...
  it('supports all three nav styles', () => {
    const styles: PageNavConfig['style'][] = ['tabs', 'pills', 'sidebar'];
    styles.forEach(style => {
      const config: PageNavConfig = { ...DEFAULT_PAGE_NAV_CONFIG, style };
  ...
  it('collapsible only applies to left position', () => {
    ...
    const topConfig: PageNavConfig = { ...config, position: 'top' };
  ...
  it('showLabels can be toggled for icon-only mode', () => {
    const iconOnly: PageNavConfig = { ...DEFAULT_PAGE_NAV_CONFIG, showLabels: false };
