...
export class PhzAdminReport extends LitElement {
  static styles = [
    adminBaseStyles,
    css`
      :host { display: block; }
  ...
  private _emit(key: string, value: string | string[]) {
  ...
  private _handleDescriptionInput(e: InputEvent) {
...
declare global {
  interface HTMLElementTagNameMap { 'phz-admin-report': PhzAdminReport; }
}
