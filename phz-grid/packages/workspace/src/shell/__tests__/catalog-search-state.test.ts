...
import {
  ...
  setCatalogSearchMode,
  setCatalogSearchQuery,
  clearCatalogSearch,
  setCatalogTypeFilter,
  selectCatalogDataSource,
  selectCatalogDataElement,
  setCatalogSort,
  setCatalogArtifacts,
  setCatalogDataSources,
  setCatalogDataElements,
  getArtifactSearchResults,
  getDataSourceSearchResults,
  getDataElementSearchResults,
  getUnifiedSearchResults,
  getAvailableCatalogArtifactTypes,
  getArtifactCountByDataSource,
  getArtifactCountByDataElement,
  type CatalogArtifact,
  type CatalogDataSource,
  type CatalogDataElement,
...
function makeArtifact(overrides: Partial<CatalogArtifact> = {}): CatalogArtifact {
  return {
    id: 'art-1',
    name: 'Sales Report',
    type: 'report',
...
function makeDataSource(overrides: Partial<CatalogDataSource> = {}): CatalogDataSource {
  return {
    id: 'ds-1',
    name: 'Sales DB',
    type: 'duckdb',
...
function makeDataElement(overrides: Partial<CatalogDataElement> = {}): CatalogDataElement {
  return {
    name: 'revenue',
    role: 'measure',
    dataSourceId: 'ds-1',
...
function stateWithData(): CatalogSearchState {
