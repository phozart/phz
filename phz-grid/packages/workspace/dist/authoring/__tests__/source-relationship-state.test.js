...
import { initialSourceRelationshipState, addSourceRelationship, removeSourceRelationship, updateSourceRelationship, startEditRelationship, commitEditRelationship, cancelEditRelationship, autoDetectRelationships, applySuggestedRelationships, validateRelationships, _resetRelationshipCounter, } from '../source-relationship-state.js';
// ── Helpers ──────────────────────────────────────────────────────
...
describe('SourceRelationshipState', () => {
    ...
    describe('edit flow', () => {
        ...
        it('commitEditRelationship saves draft back into relationships', () => {
            let s = addSourceRelationship(initialSourceRelationshipState(), makeRel());
            s = startEditRelationship(s, 'rel-1');
            s = { ...s, editingDraft: { ...s.editingDraft, joinType: 'full' } };
...
//# sourceMappingURL=source-relationship-state.test.js.map