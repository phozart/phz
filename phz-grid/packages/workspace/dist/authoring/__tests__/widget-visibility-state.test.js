...
import { initialWidgetVisibilityState, setVisibilityCondition, removeVisibilityCondition, startEditCondition, commitCondition, cancelEditCondition, evaluateVisibility, getVisibleWidgets, } from '../widget-visibility-state.js';
// --- Fixtures ---
...
function makeWidget(id, title = 'Widget') {
    return {
        id: id,
        type: 'kpi-card',
        title,
...
describe('widget-visibility-state', () => {
    ...
    describe('evaluateVisibility', () => {
        it('should evaluate eq operator correctly', () => {
            const expr = { field: 'region', operator: 'eq', value: 'US' };
...
//# sourceMappingURL=widget-visibility-state.test.js.map