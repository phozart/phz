...
import { initialVisibilityDialogState, setVisibility, addShareTarget, removeShareTarget, prepareTransition, confirmTransition, validateTransition, } from '../visibility-dialog-state.js';
function makeTarget(id, type = 'user') {
...
//# sourceMappingURL=visibility-dialog-state.test.js.map