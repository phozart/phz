...
import { initialReportFormattingState, addFormattingRule, removeFormattingRule, updateFormattingRule, reorderRules, startEditFormattingRule, commitFormattingRule, } from '../report-formatting-state.js';
function makeRule(id, field, priority = 0) {
    return {
        id,
        field,
...
describe('ReportFormattingState', () => {
    ...
    describe('updateFormattingRule', () => {
        ...
        it('preserves the id even if updates try to override it', () => {
            let s = addFormattingRule(initialReportFormattingState(), makeRule('r-1', 'revenue'));
            s = updateFormattingRule(s, 'r-1', { id: 'hacked' });
            expect(s.rules[0].id).toBe('r-1');
        });
    ...
    describe('startEditFormattingRule / commitRule', () => {
        ...
        it('commitFormattingRule applies draft and clears editing state', () => {
            let s = addFormattingRule(initialReportFormattingState(), makeRule('r-1', 'revenue'));
            s = startEditFormattingRule(s, 'r-1');
            s = { ...s, ruleDraft: { ...s.ruleDraft, condition: 'lessThan', value: 50 } };
...
//# sourceMappingURL=report-formatting-state.test.js.map