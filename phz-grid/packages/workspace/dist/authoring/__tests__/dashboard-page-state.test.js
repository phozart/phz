...
import { createPage, addPage, removePage, reorderPages, setActivePage, updatePageLabel, setPageNavConfig, duplicatePage, migrateSinglePageDashboard, getActivePage, _resetPageCounter, DEFAULT_PAGE_NAV_CONFIG, } from '../dashboard-page-state.js';
import { initialDashboardEditorState, _resetWidgetCounter, addWidget, } from '../dashboard-editor-state.js';
describe('dashboard-page-state', () => {
    ...
    it('migrates a legacy single-page state to multi-page', () => {
        ...
        const legacy = { ...state, pages: [], activePageId: '' };
...
//# sourceMappingURL=dashboard-page-state.test.js.map