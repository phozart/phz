...
import { initialEditorCriteriaState, toggleCriteria, setCriteriaConfig, addCriteriaFilter, removeCriteriaFilter, clearCriteriaFilters, } from '../editor-criteria-state.js';
...
describe('EditorCriteriaState', () => {
    ...
    describe('addCriteriaFilter', () => {
        ...
        it('replaces existing filter with same id', () => {
            ...
            const updated = { ...makeFilter('f-1', 'region'), value: 'updated' };
...
//# sourceMappingURL=editor-criteria-state.test.js.map