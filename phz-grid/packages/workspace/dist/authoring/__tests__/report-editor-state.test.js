...
import { initialReportEditorState, addColumn, removeColumn, reorderColumns, updateColumn, toggleColumnVisibility, pinColumn, addFilter, removeFilter, setSorting, setGrouping, addConditionalFormat, removeConditionalFormat, setDensity, setConfigPanelTab, selectColumn, toGridConfig, } from '../report-editor-state.js';
function makeState() {
...
describe('ReportEditorState', () => {
    ...
    describe('updateColumn', () => {
        ...
        it('preserves the field even if updates try to override it', () => {
            const s = updateColumn(makeState(), 'revenue', { field: 'hacked' });
    ...
    describe('addFilter', () => {
        ...
        it('replaces existing filter with same filterId', () => {
            ...
            const f1Updated = { ...f1, value: 'updated' };
    ...
    describe('setSorting', () => {
        it('replaces the sorting array', () => {
            const sorting = [{ field: 'revenue', direction: 'desc' }];
        ...
        it('can clear sorting with empty array', () => {
            const s = setSorting(setSorting(initialReportEditorState('R', 'ds-1'), [{ field: 'x', direction: 'asc' }]), []);
            expect(s.sorting).toEqual([]);
        });
    });
...
//# sourceMappingURL=report-editor-state.test.js.map