...
import { createBookmark, updateBookmark, deleteBookmark, setDefaultBookmark, setActiveBookmark, captureInteractionState, restoreInteractionState, generateBookmarkDescription, resolveInitialState, } from '../bookmark-state.js';
// ========================================================================
// Helpers
// ========================================================================
function emptyState() {
...
describe('captureInteractionState', () => {
    it('creates a snapshot from individual parameters', () => {
        const result = captureInteractionState({ region: 'US' }, ['w1'], { widget1: { hierarchyId: 'geo', currentLevel: 0, breadcrumb: [], filterStack: [] } }, { chart1: { value: 'x' } }, { group1: 'tab-a' }, { x: 0, y: 100 });
...
//# sourceMappingURL=bookmark-state.test.js.map