...
import { initialReportChartState, setPreviewMode, overrideChartType, getEffectiveChartType, setEncoding, removeEncoding, autoMapColumnsToEncoding, getChartTypeAvailability, } from '../report-chart-state.js';
function makeField(name, dataType, hint) {
...
describe('ReportChartState', () => {
    ...
    describe('getEffectiveChartType', () => {
        ...
        it('returns auto-suggested chartType when no override', () => {
            const s = { ...initialReportChartState(), chartType: 'area' };
    ...
    describe('getChartTypeAvailability', () => {
        ...
        it('enables gauge with a single value', () => {
            const encoding = { value: ['score'], tooltip: [] };
            const avail = getChartTypeAvailability(encoding);
            expect(avail.gauge).toBe(true);
        });
        it('enables scatter with category and value', () => {
            const encoding = { category: 'x', value: ['y'], tooltip: [] };
            const avail = getChartTypeAvailability(encoding);
...
//# sourceMappingURL=report-chart-state.test.js.map