...
import { initialReportEditorState, addColumn, removeColumn, toggleColumnVisibility, setDensity, setConfigPanelTab, selectColumn, removeFilter, toGridConfig, } from './report-editor-state.js';
import { initialReportChartState, setPreviewMode, overrideChartType, getEffectiveChartType, setEncoding, removeEncoding, getChartTypeAvailability, } from './report-chart-state.js';
...
let PhzReportEditor = class PhzReportEditor extends LitElement {
    constructor() {
        super(...arguments);
        ...
        this._chartState = initialReportChartState();
    }
    ...
    render() {
      ...
      <div class="config-panel ${this._showConfigPanel ? '' : 'hidden'}">
        <div class="panel-tabs">
          ${['columns', 'filters', 'style', 'formatting', 'drill', 'chart'].map(tab => html `
    ...
    _renderPanelContent() {
        ...
        switch (this._state.configPanelTab) {
          ...
          <div class="column-list">
            ${this._state.columns.map(col => html `
              <div class="column-item ${this._state.selectedColumnField === col.field ? 'selected' : ''}"
                ...
                <button class="filter-remove" @click=${(e) => { e.stopPropagation(); this._removeColumn(col.field); }}
          ...
          ${this.availableFields.filter(f => !this._state.columns.some(c => c.field === f.field)).length > 0
              ...
              <button class="add-field-btn" @click=${() => {
                        ...
                        if (available)
                            this._addColumn(available.field, available.label);
                    }}>+ Add Column</button>
            ` : nothing}
        `;
            case 'filters':
        ...
        `;
          ...
          <div class="density-group">
            ${['compact', 'dense', 'comfortable'].map(d => html `
        ...
        `;
            case 'chart': {
                ...
                const chartTypes = ['bar-chart', 'line', 'area', 'pie', 'scatter', 'gauge', 'kpi-card', 'trend-line'];
                const chartLabels = {
...
], PhzReportEditor.prototype, "name", void 0);
__decorate([
    property({ type: String })
], PhzReportEditor.prototype, "dataSourceId", void 0);
__decorate([
    property({ type: Array })
], PhzReportEditor.prototype, "availableFields", void 0);
__decorate([
    property({ attribute: false })
], PhzReportEditor.prototype, "adapter", void 0);
__decorate([
    state()
], PhzReportEditor.prototype, "_state", void 0);
__decorate([
    state()
], PhzReportEditor.prototype, "_showConfigPanel", void 0);
__decorate([
    state()
], PhzReportEditor.prototype, "_criteriaState", void 0);
__decorate([
    state()
], PhzReportEditor.prototype, "_chartState", void 0);
PhzReportEditor = __decorate([
    safeCustomElement('phz-report-editor')
], PhzReportEditor);
export { PhzReportEditor };
//# sourceMappingURL=phz-report-editor.js.map