...
let PhzGridAdmin = class PhzGridAdmin extends LitElement {
    constructor() {
        super(...arguments);
        this.open = false;
        ...
        this._handleTableSettingsChange = (e) => {
            const { key, value } = e.detail;
            this.tableSettings = { ...this.tableSettings, [key]: value };
            this.scheduleAutoSave();
        };
        this._handleColumnConfigChange = (e) => {
        ...
        this._handleRulesChange = (e) => {
            ...
            if (action === 'add') {
                ...
                rules = rules.map((r) => {
                    if (r.id !== ruleId || !updates)
                        return r;
                    const updated = { ...r };
                    if (updates.field !== undefined)
                        updated.field = updates.field;
                    if (updates.operator !== undefined)
                        updated.condition = { ...updated.condition, operator: updates.operator };
                    if (updates.value !== undefined)
                        updated.condition = { ...updated.condition, value: updates.value };
                    if (updates.value2 !== undefined)
                        updated.condition = { ...updated.condition, value2: updates.value2 };
                    if (updates.backgroundColor !== undefined)
                        updated.style = { ...updated.style, backgroundColor: updates.backgroundColor };
                    if (updates.color !== undefined)
                        updated.style = { ...updated.style, color: updates.color };
                    if (updates.fontWeight !== undefined)
                        updated.style = { ...updated.style, fontWeight: updates.fontWeight };
                    return updated;
                });
            }
            this.formattingRules = rules;
        };
        this._handleColumnsChange = (e) => {
            const { action, visibleFields } = e.detail;
            if (action === 'show-all') {
                this.columns = (this.columns ?? []).map((c) => ({ ...c, visible: true }));
            }
            else if (action === 'hide-all') {
                this.columns = (this.columns ?? []).map((c) => ({ ...c, visible: false }));
            }
            else if (visibleFields) {
                this.columns = (this.columns ?? []).map((c) => ({ ...c, visible: visibleFields.includes(c.field) }));
            }
        };
    }
    static { this.styles = [
    ...
    connectedCallback() {
        ...
        this.addEventListener('table-settings-change', this._handleTableSettingsChange);
        this.addEventListener('column-config-change', this._handleColumnConfigChange);
        this.addEventListener('rules-change', this._handleRulesChange);
        this.addEventListener('columns-change', this._handleColumnsChange);
    }
    updated(changed) {
        if (changed.has('open')) {
            if (this.open) {
    ...
    disconnectedCallback() {
        ...
        document.body.style.overflow = '';
        this.removeEventListener('table-settings-change', this._handleTableSettingsChange);
        this.removeEventListener('column-config-change', this._handleColumnConfigChange);
        this.removeEventListener('rules-change', this._handleRulesChange);
        this.removeEventListener('columns-change', this._handleColumnsChange);
    }
    ...
    getSettings() {
        ...
        const exportEl = this.shadowRoot?.querySelector('phz-admin-export');
        if (exportEl) {
...
], PhzGridAdmin.prototype, "open", void 0);
__decorate([
    property({ type: String })
], PhzGridAdmin.prototype, "reportId", void 0);
__decorate([
    property({ type: String })
], PhzGridAdmin.prototype, "reportName", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "availableReports", void 0);
__decorate([
    property({ type: Array })
], PhzGridAdmin.prototype, "columns", void 0);
__decorate([
    property({ type: Array })
], PhzGridAdmin.prototype, "formattingRules", void 0);
__decorate([
    property({ type: Array })
], PhzGridAdmin.prototype, "fields", void 0);
__decorate([
    property({ type: Object })
], PhzGridAdmin.prototype, "filterPresets", void 0);
__decorate([
    property({ type: Object })
], PhzGridAdmin.prototype, "themeTokens", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "columnTypes", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "statusColors", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "barThresholds", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "dateFormats", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "linkTemplates", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "tableSettings", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "columnFormatting", void 0);
__decorate([
    property({ attribute: false })
], PhzGridAdmin.prototype, "numberFormats", void 0);
__decorate([
    state()
], PhzGridAdmin.prototype, "activeTab", void 0);
__decorate([
    state()
], PhzGridAdmin.prototype, "_saveState", void 0);
PhzGridAdmin = __decorate([
