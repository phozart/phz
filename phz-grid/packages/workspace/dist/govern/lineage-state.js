...
// Factory
// ========================================================================
export function initialLineageState() {
    return {
        graph: { nodes: [], edges: [] },
        filter: {},
    };
...
// buildLineageGraph
// ========================================================================
export function buildLineageGraph(artifacts, dependencies) {
...
// ========================================================================
export function layoutDAG(graph) {
...
// ========================================================================
export function getUpstreamLineage(graph, nodeId) {
...
// ========================================================================
export function getDownstreamLineage(graph, nodeId) {
    const nodeExists = graph.nodes.some(n => n.id === nodeId);
    if (!nodeExists)
        return { nodes: [], edges: [] };
...
// ========================================================================
export function getImpactedNodes(graph, nodeId) {
    // Build forward adjacency: source → targets
    const childrenMap = new Map();
    for (const edge of graph.edges) {
        let list = childrenMap.get(edge.source);
...
// ========================================================================
export function filterByArtifactType(graph, types) {
...
export function setLineageFilter(state, filter) {
    return { ...state, filter };
}
export function setHoveredNode(state, nodeId) {
