...
import { getShellConfig } from '../shell/shell-roles.js';
import { NAV_ITEMS, NAV_CREATE, NAV_TOOLS, VIEW_PANELS, } from '../workspace-config.js';
let PhzWorkspaceNavbar = class PhzWorkspaceNavbar extends LitElement {
    constructor() {
        super(...arguments);
        this.activeViewType = 'catalog';
        this.activeDrawer = null;
        this.workspaceRole = 'admin';
    }
    static { this.TAG = 'phz-workspace-navbar'; }
  ...
  `; }
    _getVisibleTools() {
        ...
        return NAV_TOOLS.filter(item => {
            if (item.section === 'GOVERN' && !sections.has('GOVERN'))
                return false;
            return true;
        });
    }
...
], PhzWorkspaceNavbar.prototype, "activeViewType", void 0);
__decorate([
    property({ type: String })
], PhzWorkspaceNavbar.prototype, "activeDrawer", void 0);
__decorate([
    property({ type: String, attribute: 'workspace-role' })
], PhzWorkspaceNavbar.prototype, "workspaceRole", void 0);
PhzWorkspaceNavbar = __decorate([
    safeCustomElement('phz-workspace-navbar')
], PhzWorkspaceNavbar);
export { PhzWorkspaceNavbar };
//# sourceMappingURL=phz-workspace-navbar.js.map