...
// Factory
// ========================================================================
export function initialCatalogDenseState(artifacts = []) {
    return {
        artifacts,
...
// Filtering
// ========================================================================
export function filterDenseArtifacts(state) {
...
// Pagination
// ========================================================================
export function getPagedArtifacts(state) {
...
// Inline actions
// ========================================================================
export function applyInlineAction(state, action) {
    switch (action.kind) {
        case 'rename':
            return {
                ...state,
                artifacts: state.artifacts.map(a => a.id === action.artifactId
...
// ========================================================================
export function canApplyBulkAction(state, action) {
...
export function applyBulkAction(state, action) {
    if (!canApplyBulkAction(state, action))
        return state;
    switch (action) {
        case 'delete':
            return {
        ...
        case 'publish':
            return {
                ...state,
                artifacts: state.artifacts.map(a => state.selectedIds.has(a.id) ? { ...a, published: true, updatedAt: Date.now() } : a),
                selectedIds: new Set(),
            };
        case 'unpublish':
            return {
                ...state,
                artifacts: state.artifacts.map(a => state.selectedIds.has(a.id) ? { ...a, published: false, updatedAt: Date.now() } : a),
                selectedIds: new Set(),
            };
        case 'share':
...
//# sourceMappingURL=catalog-dense-state.js.map