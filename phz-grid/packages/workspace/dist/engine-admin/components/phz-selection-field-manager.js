...
let PhzSelectionFieldManager = class PhzSelectionFieldManager extends LitElement {
    constructor() {
        super(...arguments);
        this.fields = [];
    }
    ...
    render() {
        const types = ['single_select', 'multi_select', 'period_picker', 'chip_group', 'text'];
        return html `
...
__decorate([
    property({ type: Array })
], PhzSelectionFieldManager.prototype, "fields", void 0);
__decorate([
    state()
], PhzSelectionFieldManager.prototype, "editingId", void 0);
PhzSelectionFieldManager = __decorate([
    safeCustomElement('phz-selection-field-manager')
], PhzSelectionFieldManager);
export { PhzSelectionFieldManager };
//# sourceMappingURL=phz-selection-field-manager.js.map