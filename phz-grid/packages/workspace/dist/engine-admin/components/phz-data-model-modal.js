...
let PhzDataModelModal = class PhzDataModelModal extends LitElement {
    constructor() {
        super(...arguments);
        this.open = false;
    ...
    _renderForm() {
        ...
        switch (this.entityType) {
            case 'parameters':
                return html `
          <phz-parameter-form
            .parameter=${this._getEditEntity()}
            .isEdit=${isEdit}
            @parameter-save=${(e) => this.dispatchEvent(new CustomEvent('parameter-save', { bubbles: true, composed: true, detail: e.detail }))}
        ...
        `;
          ...
          <phz-calculated-field-form
            .calculatedField=${this._getEditEntity()}
            .isEdit=${isEdit}
            .fields=${this.fields}
            .parameters=${this.parameters}
            .calculatedFields=${this.calculatedFields}
            .previewData=${this.previewData.slice(0, 3)}
            @calculated-field-save=${(e) => this.dispatchEvent(new CustomEvent('calculated-field-save', { bubbles: true, composed: true, detail: e.detail }))}
        ...
        `;
            case 'metrics':
                return html `
          <phz-metric-form
            .metric=${this._getEditEntity()}
            .isEdit=${isEdit}
            .fields=${this.fields}
            .parameters=${this.parameters}
            .calculatedFields=${this.calculatedFields}
            .metrics=${this.metrics}
            @metric-save=${(e) => this.dispatchEvent(new CustomEvent('metric-save', { bubbles: true, composed: true, detail: e.detail }))}
        ...
        `;
            case 'kpis':
                return html `
          <phz-kpi-form
            .kpi=${this._getEditEntity()}
            .isEdit=${isEdit}
            .metrics=${this.metrics}
            .parameters=${this.parameters}
            @kpi-save=${(e) => this.dispatchEvent(new CustomEvent('kpi-save', { bubbles: true, composed: true, detail: e.detail }))}
...
], PhzDataModelModal.prototype, "open", void 0);
__decorate([
    property({ type: String })
], PhzDataModelModal.prototype, "entityType", void 0);
__decorate([
    property({ type: String })
], PhzDataModelModal.prototype, "editId", void 0);
__decorate([
    property({ type: Array })
], PhzDataModelModal.prototype, "fields", void 0);
__decorate([
    property({ type: Array })
], PhzDataModelModal.prototype, "parameters", void 0);
__decorate([
    property({ type: Array })
], PhzDataModelModal.prototype, "calculatedFields", void 0);
__decorate([
    property({ type: Array })
], PhzDataModelModal.prototype, "metrics", void 0);
__decorate([
    property({ type: Array })
], PhzDataModelModal.prototype, "kpis", void 0);
__decorate([
    property({ type: Array })
], PhzDataModelModal.prototype, "previewData", void 0);
__decorate([
    property({ type: Object })
], PhzDataModelModal.prototype, "engine", void 0);
PhzDataModelModal = __decorate([
    safeCustomElement('phz-data-model-modal')
], PhzDataModelModal);
export { PhzDataModelModal };
//# sourceMappingURL=phz-data-model-modal.js.map