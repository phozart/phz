...
let PhzShareDialog = class PhzShareDialog extends LitElement {
    constructor() {
        super(...arguments);
        this.open = false;
        this.embedCode = '';
...
], PhzShareDialog.prototype, "open", void 0);
__decorate([
    property({ type: String })
], PhzShareDialog.prototype, "embedCode", void 0);
__decorate([
    property({ type: String })
], PhzShareDialog.prototype, "jsonConfig", void 0);
__decorate([
    property({ type: String })
], PhzShareDialog.prototype, "shareableUrl", void 0);
__decorate([
    state()
], PhzShareDialog.prototype, "_activeTab", void 0);
__decorate([
    state()
], PhzShareDialog.prototype, "_copyFeedback", void 0);
PhzShareDialog = __decorate([
    safeCustomElement('phz-share-dialog')
], PhzShareDialog);
export { PhzShareDialog };
//# sourceMappingURL=phz-share-dialog.js.map