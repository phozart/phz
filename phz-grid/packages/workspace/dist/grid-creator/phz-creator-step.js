...
let PhzCreatorStep = class PhzCreatorStep extends LitElement {
    constructor() {
        super(...arguments);
        this.currentStep = 0;
        this.totalSteps = 5;
...
], PhzCreatorStep.prototype, "currentStep", void 0);
__decorate([
    property({ type: Number, attribute: 'total-steps' })
], PhzCreatorStep.prototype, "totalSteps", void 0);
__decorate([
    property({ attribute: false })
], PhzCreatorStep.prototype, "completedSteps", void 0);
PhzCreatorStep = __decorate([
    safeCustomElement('phz-creator-step')
], PhzCreatorStep);
export { PhzCreatorStep };
//# sourceMappingURL=phz-creator-step.js.map