 ...
 */
export function generateLayoutHTML(node) {
    switch (node.kind) {
...
function generateWidgetSlotHTML(node) {
    const style = [];
    if (node.minHeight)
...
export function generateGridHTML(node) {
...
export function generateTabsHTML(node) {
...
export function generateSectionsHTML(node) {
...
export function generateFreeformHTML(node) {
...
//# sourceMappingURL=phz-layout-container.js.map