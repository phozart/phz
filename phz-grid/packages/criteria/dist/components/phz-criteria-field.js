...
let PhzCriteriaField = class PhzCriteriaField extends LitElement {
    constructor() {
        super(...arguments);
        this.value = null;
    ...
    static { this.styles = [criteriaStyles]; }
    _fire(newValue) {
    ...
    _onSelectChange(e) {
        this._fire(e.target.value || null);
    }
    _onMultiSelectToggle(optionValue) {
    ...
    _renderField() {
        ...
        `;
            ...
            case 'field_presence': {
                ...
                if (typeof this.value === 'string' && this.value) {
                    try {
                        presenceVal = JSON.parse(this.value);
                    }
                    catch { /* ignore */ }
                }
                return html `
...
], PhzCriteriaField.prototype, "fieldDef", void 0);
__decorate([
    property({ attribute: false })
], PhzCriteriaField.prototype, "value", void 0);
__decorate([
    property({ type: Array })
], PhzCriteriaField.prototype, "filteredOptions", void 0);
__decorate([
    property({ type: Boolean })
], PhzCriteriaField.prototype, "locked", void 0);
PhzCriteriaField = __decorate([
    customElement('phz-criteria-field')
], PhzCriteriaField);
export { PhzCriteriaField };
//# sourceMappingURL=phz-criteria-field.js.map