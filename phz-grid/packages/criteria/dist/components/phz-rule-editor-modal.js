...
function defaultConfigForType(type) {
    switch (type) {
        ...
        case 'cross_filter':
            return {
                type: 'cross_filter',
                conditions: [{ source: 'filter', key: '', operator: 'equals', values: [] }],
                logic: 'all',
                action: { type: 'include_values', values: [] },
            };
    }
}
let PhzRuleEditorModal = class PhzRuleEditorModal extends LitElement {
    constructor() {
        super(...arguments);
  ...
  `]; }
    ...
    _renderDescriptionField() {
      ...
      <div class="phz-rem-field">
        ...
        <input class="phz-rem-input" type="text"
               ...
               @input=${(e) => { this._description = e.target.value; this._clearError('description'); }}>
    ...
    _renderDefinitionPicker() {
      ...
      <div class="phz-rem-field">
        ...
        <phz-combobox
          ...
          @combobox-change=${(e) => { this._filterDefId = e.detail.value; this._clearError('filterDefId'); }}
        ></phz-combobox>
    ...
    _renderPatternFields() {
      ...
      <div class="phz-rem-field">
        ...
        <input class="phz-rem-input ${hasPatternError ? 'phz-rem-input--error' : ''}" type="text"
               ...
               .value=${this._pattern}
               @input=${(e) => { this._pattern = e.target.value; this._clearError('pattern'); }}>
      ...
      <div class="phz-rem-field phz-rem-field--narrow">
        ...
        <input class="phz-rem-input" type="text"
               placeholder="i"
               .value=${this._flags}
               @input=${(e) => { this._flags = e.target.value; }}>
    ...
    _renderValueSetFields() {
      ...
      <div class="phz-rem-field">
        ...
        <span class="phz-rem-hint">${this._vsMode === 'include'
            ...
            : 'These values will be hidden from the filter'}</span>
      </div>
      <div class="phz-rem-field">
        ...
        <textarea class="phz-rem-textarea ${hasValuesError ? 'phz-rem-input--error' : ''}"
                  ...
                  @input=${(e) => { this._vsValues = e.target.value; this._clearError('values'); }}
        ></textarea>
    ...
    _renderTreeGroupFields() {
      ...
      <div class="phz-rem-field">
        ...
        <input class="phz-rem-input ${hasFieldError ? 'phz-rem-input--error' : ''}" type="text"
               ...
               .value=${this._tgField}
               @input=${(e) => { this._tgField = e.target.value; this._clearError('groupField'); }}>
      ...
      <div class="phz-rem-row">
        <div class="phz-rem-field">
          ...
          <phz-combobox
            ...
            .allowEmpty=${false}
            @combobox-change=${(e) => { this._tgOperator = e.detail.value; }}
          ></phz-combobox>
        </div>
        ${this._tgOperator === 'in' || this._tgOperator === 'not_in' ? html `
          <div class="phz-rem-field">
            ...
            <textarea class="phz-rem-textarea"
                      ...
                      @input=${(e) => { this._tgValues = e.target.value; this._clearError('tgValues'); }}
            ></textarea>
            <span class="phz-rem-hint">
              ${this._tgValues.trim()
    ...
    _renderCustomFields() {
      ...
      <div class="phz-rem-field">
        ...
        <input class="phz-rem-input ${hasKeyError ? 'phz-rem-input--error' : ''}" type="text"
               ...
               @input=${(e) => { this._customKey = e.target.value; this._clearError('evaluatorKey'); }}>
      ...
      <div class="phz-rem-field">
        ...
        <textarea class="phz-rem-textarea ${!paramsValid && this._customParams.trim() ? 'phz-rem-input--error' : ''}"
                  ...
                  @input=${(e) => { this._customParams = e.target.value; }}
        ></textarea>
    ...
    _renderCrossFilterFields() {
      ...
      ${this._cfConditions.length > 1 ? html `
        <div class="phz-rem-field">
          ...
          <span class="phz-rem-hint">${this._cfLogic === 'all'
            ...
            : 'At least one condition must be true for the action to apply'}</span>
        </div>
      ` : nothing}
      ...
      <div class="phz-rem-field">
        ...
        <span class="phz-rem-hint">${this._cfBehavior === 'include'
            ...
            : 'The listed values will be removed from the options'}</span>
      </div>

      <div class="phz-rem-field">
        <label class="phz-rem-label">Values come from</label>
        <div style="display:flex;gap:8px">
          ${['fixed', 'context'].map(s => html `
      ...
      ${this._cfValueSource === 'context' ? html `
        <div class="phz-rem-field">
          ...
          <input class="phz-rem-input" type="text"
                 ...
                 @input=${(e) => { this._cfActionContextKey = e.target.value; this._clearError('cfActionValues'); }}>
      ...
      ` : html `
        <div class="phz-rem-field">
          ...
          <textarea class="phz-rem-textarea"
                    ...
                    @input=${(e) => { this._cfActionValues = e.target.value; this._clearError('cfActionValues'); }}
          ></textarea>
          <span class="phz-rem-hint">${this._cfBehavior === 'include'
            ? 'Only these values will be available as options'
            : 'These values will be removed from the options'}</span>
        </div>
      `}
      ...
      <div class="phz-rem-field">
        ...
        <div style="display:flex;gap:8px">
          ${['pass_through', 'block'].map(ea => html `
        ...
        <span class="phz-rem-hint">${this._cfElseAction === 'pass_through'
            ...
            : 'No options are available when conditions are not met'}</span>
      </div>
    `;
    }
    _renderCondition(cond, idx) {
        ...
        <div class="phz-rem-row">
          <div class="phz-rem-field">
            ...
            <phz-combobox
              ...
              .value=${cond.source}
              .allowEmpty=${false}
              @combobox-change=${(e) => { this._updateCondition(idx, 'source', e.detail.value); }}
            ></phz-combobox>
          </div>
          <div class="phz-rem-field">
            ${cond.source === 'filter' ? html `
              ...
              <phz-combobox
                ...
                .allowEmpty=${false}
                empty-label="\u2014 Select a filter \u2014"
                @combobox-change=${(e) => { this._updateCondition(idx, 'key', e.detail.value); }}
              ></phz-combobox>
            ` : html `
              ...
              <input class="phz-rem-input" type="text"
                     ...
                     .value=${cond.key}
                     @input=${(e) => { this._updateCondition(idx, 'key', e.target.value); }}>
            `}
          </div>
        </div>
        <div class="phz-rem-row">
          <div class="phz-rem-field">
            ...
            <phz-combobox
              ...
              .value=${cond.operator}
              .allowEmpty=${false}
              @combobox-change=${(e) => { this._updateCondition(idx, 'operator', e.detail.value); }}
            ></phz-combobox>
          </div>
          ${needsValues ? html `
            <div class="phz-rem-field">
              ...
              <input class="phz-rem-input" type="text"
                     ...
                     @input=${(e) => { this._updateCondition(idx, 'values', e.target.value); }}>
            </div>
          ` : nothing}
        </div>
      </div>
    ...
    _updateCondition(idx, field, value) {
      ...
      <div class="phz-rem-row">
        <div class="phz-rem-field" style="flex:0 0 120px">
          ...
          <input class="phz-rem-input" type="number" min="0" step="1"
                 ...
                 @input=${(e) => { this._priority = parseInt(e.target.value, 10) || 0; }}>
    ...
    _buildRule() {
        ...
        return {
            id,
            filterDefinitionId: this._filterDefId,
            type: this._type,
...
], PhzRuleEditorModal.prototype, "rule", void 0);
__decorate([
    property({ type: Array })
], PhzRuleEditorModal.prototype, "definitions", void 0);
__decorate([
    property({ type: String })
], PhzRuleEditorModal.prototype, "mode", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PhzRuleEditorModal.prototype, "open", void 0);
__decorate([
    property({ type: Number })
], PhzRuleEditorModal.prototype, "maxPriority", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_type", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_description", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_filterDefId", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_priority", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_enabled", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_pattern", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_flags", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_vsMode", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_vsValues", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_tgField", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_tgOperator", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_tgValue", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_tgValues", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_customKey", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_customParams", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_cfConditions", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_cfLogic", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_cfValueSource", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_cfBehavior", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_cfActionValues", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_cfActionContextKey", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_cfElseAction", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_errors", void 0);
__decorate([
    state()
], PhzRuleEditorModal.prototype, "_submitted", void 0);
PhzRuleEditorModal = __decorate([
    customElement('phz-rule-editor-modal')
], PhzRuleEditorModal);
export { PhzRuleEditorModal };
//# sourceMappingURL=phz-rule-editor-modal.js.map