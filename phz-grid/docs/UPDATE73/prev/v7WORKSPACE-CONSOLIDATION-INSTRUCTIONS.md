...
interface VersionedConfig {
  ...
  $version: number
  id: string
  type: 'report' | 'dashboard' | 'kpi' | 'template' | 'placement' |
        'alert-rule' | 'subscription' | 'filter-preset' | 'explore-session'
  name: string
  createdAt: string
  updatedAt: string
...
export type {
  ...
  UnitSpec, DataQualityInfo, FieldMapping, NavigationLink, LocalSession, I18nProvider
