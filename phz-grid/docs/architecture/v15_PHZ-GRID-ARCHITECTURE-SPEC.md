...
#### `@phozart/workspace` (admin + author shell)
...
#### `@phozart/viewer` (consumption shell)
...
#### `@phozart/editor` (future, constrained personalisation)
...
| createDataExplorer() | @phozart/workspace | Complete (moves to engine) |
...
| TimeIntelligenceConfig | @phozart/workspace | Complete |
